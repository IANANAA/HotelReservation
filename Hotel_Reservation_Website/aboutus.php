...
<body>
	...
	<ul id = "menu">
		...
		<li><a href = "dineandlounge.php">Food</a></li> |			
	...
	<div style = "margin-left:0;" class = "container">
		<div class = "panel panel-default">
			<div class = "panel-body">
				...
				<p style = "position:relative; float:left; width:850px;">The hotel features a prominent balance of nostalgia and contemporary style, capturing Southern elegance, luxury and decadence. Machuca tiles form cool geometric patterns in the hallways. The hotel's wooden floors contrast with the modern furnishings and amenities in its dramatic rooms. The hotel's lifestyle offers guests the ultimate in sensory luxury: soothing organic toiletries, heritage recipes, and unparalleled privacy and serenity.</p>
	...
	<div style = "text-align:right; margin-right:10px;" class = "navbar navbar-default navbar-fixed-bottom">
		<label>&copy; Copyright Kelompok 11, 2023 </label>
	</div>
</body>
